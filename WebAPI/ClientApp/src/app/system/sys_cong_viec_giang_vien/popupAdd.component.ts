...
export class sys_cong_viec_giang_vien_popupComponent {
  ...
  Save(): void {
    // this.sys_cong_viec_giang_vien_service.addUser(this.user_model).subscribe((result) => {
    //   var data: any = result;
  ...
  Edit(): void {
    // this.sys_cong_viec_giang_vien_service.editUser(this.user_model).subscribe((result) => {
    //   Swal.fire({
    //     icon: 'success',
    //     title: 'Thành công',
    //     showConfirmButton: false,
