...
@Component({
  selector: 'sys_giang_vien_khoa_popup',
  templateUrl: './popupAdd.component.html',
  styleUrls: ['./popupAdd.component.scss'],

})
export class sys_giang_vien_khoa_popupComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<sys_giang_vien_khoa_popupComponent>,
